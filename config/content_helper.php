...
function load_site_content($conexion, string $lang = 'es') {
    $defaults = [
        ...
        'ev_menus_label'     => 'Propuesta de menús',
        'ev_menus_h2'        => 'Menús de grupo y catering',
        'ev_menus_intro'     => 'Tres formatos pensados para distintos momentos del día.',
        ...
        'ev_br_label'        => 'Brunch',
        'ev_br_h2'           => 'Brunch',
        'ev_br_desc'         => 'Una propuesta completa para mañanas con tiempo: dulce, salado y bebidas para presentaciones, talleres o eventos corporativos.',
        'ev_td_label'        => 'Tardeo',
        'ev_td_h2'           => 'Tardeo',
